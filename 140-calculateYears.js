const calculateYears = (principal, interest, tax, desired, result = 0) => principal >= desired ?
    result : calculateYears(principal * (1 + interest - interest * tax), interest, tax, desired, result + 1);
